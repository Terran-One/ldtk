...
export type BaselineTransformer<TF> =
  TF extends BaseTransformer<any, infer T>
  ? T : never;
export type DeriveTransformer<Base> =
  Base extends BaseTransformer<any, any>
  ? TransformMap<TransformVisitorFromBase<Base>>
  : never;
