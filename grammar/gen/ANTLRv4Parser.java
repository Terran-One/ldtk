...
public class ANTLRv4Parser extends Parser {
	...
	public static final int
		...
		RULE_ruleref = 58, RULE_characterRange = 59, RULE_terminal_ = 60, RULE_elementOptions = 61, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"terminal_", "elementOptions", "elementOption", "identifier"
		};
	}
	...
	public static class Terminal_Context extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ANTLRv4ParserListener ) ((ANTLRv4ParserListener)listener).enterTerminal_(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ANTLRv4ParserListener ) ((ANTLRv4ParserListener)listener).exitTerminal_(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ANTLRv4ParserVisitor ) return ((ANTLRv4ParserVisitor<? extends T>)visitor).visitTerminal_(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Terminal_Context terminal_() throws RecognitionException {
		...
		enterRule(_localctx, 120, RULE_terminal_);
		int _la;
		try {
			setState(604);
			_errHandler.sync(this);
